...
CREATE TABLE `TIPO_ESPECIALIDAD` (
  ...
  `NOMBRE_ESPECIALIDAD` varchar(90) DEFAULT NULL,
...
INSERT INTO `TIPO_ESPECIALIDAD` VALUES (1,'Cambios de llantas'),(2,'Otro'),(3,'Falta de gasolina'),(4,'Arranque'),(5,'Grua'),(6,'Falla Mecanica');
...
-- Dump completed on 2019-09-13 17:19:05
